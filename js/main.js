...
const products = [
  ...
  },
  {
    id: 9,
    brand: 'Vilebrequin',
    name: 'Moorea Tartaruga Verde',
    price: 'R$ 1.200',
    priceNum: 1200,
    sizes: ['M', 'G'],
    condition: 'Seminovo — Excelente estado',
    description: 'Short de banho Vilebrequin em azul com estampa tartaruga verde. Padrão exclusivo de coleção. Tecido leve e de secagem rápida. Label Vilebrequin original.',
    badge: 'Exclusivo',
    image: 'images/produtos/p08.webp',
    category: 'shorts'
  },
  {
    id: 10,
